                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                ...
                                @guest()
                                    <li>
                                        <span><a href="{{ route('account') }}" class="btn btn-primary text-white" style="font-size: 15px; ">Login/Registration</a></span>
                                    </li>
                                @endguest
                            </ul>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-6">
                            <p class="copyright_text">
                                ©2021 <a href="{{ route('index') }}">stowaa</a>. All Rights Reserved.
                            </p>
                        </div>
