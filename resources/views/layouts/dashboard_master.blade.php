...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('database_assests') }}/{{ asset('database_assests') }}/images/favicon.png">
    <link rel="stylesheet" href="./vendor/chartist/css/chartist.min.css">
    <link href="{{ asset('database_assests') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css"
        rel="stylesheet">
    <link href="{{ asset('database_assests') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="{{ asset('database_assests') }}/css/style.css" rel="stylesheet">
    <link
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ 'home' }}" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('database_assests') }}/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('database_assests') }}/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('database_assests') }}/images/logo-text.png" alt="">
            </a>
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('database_assests') }}/images/avatar/1.jpg"
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('database_assests') }}/images/avatar/2.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('database_assests') }}/images/avatar/3.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('database_assests') }}/images/avatar/4.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('database_assests') }}/images/avatar/5.jpg"
                                                    class="rounded-circle user_img" alt="" />
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                        ...
                        <ul class="navbar-nav header-right">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50"
                                                            src="{{ asset('database_assests') }}/images/avatar/1.jpg">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    ...
                                    @else
                                        <img src="{{ asset('database_assests') }}/images/default_profile_picture.png" class="img-fluid rounded-circle" alt="">
                                    @endif
                                    <div class="header-info">
                                        <span class="text-black"><strong>{{ Auth::user()->name }}</strong></span>
                                        <span class="text-black"><strong>{{ Auth::user()->role }}</strong></span>
                                    </div>
                                </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <div class="add-menu-sidebar">
                    <img src="{{ asset('database_assests') }}/images/calendar.png" alt="" class="mr-3">
                    <p class="	font-w500 mb-0">Create Workout Plan Now</p>
                </div>
                <div class="copyright">
                    <p><strong>Gymove Fitness Admin Dashboard</strong> © {{ \Carbon\Carbon::Now()->Format('Y') }} All
                        Rights Reserved</p>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('database_assests') }}/vendor/global/global.min.js"></script>
	<script src="{{ asset('database_assests') }}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	<script src="{{ asset('database_assests') }}/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="{{ asset('database_assests') }}/js/custom.min.js"></script>
	<script src="{{ asset('database_assests') }}/js/deznav-init.js"></script>
	<script src="{{ asset('database_assests') }}/vendor/owl-carousel/owl.carousel.js"></script>

    {!! NoCaptcha::renderJs() !!}
	<!-- Chart piety plugin files -->
    <script src="{{ asset('database_assests') }}/vendor/peity/jquery.peity.min.js"></script>

	<!-- Apex Chart -->
	<script src="{{ asset('database_assests') }}/vendor/apexchart/apexchart.js"></script>

	<!-- Dashboard 1 -->
	<script src="{{ asset('database_assests') }}/js/dashboard/dashboard-1.js"></script>
